...
.animate-slideIn { animation: slideIn var(--duration-normal) var(--ease-out); }
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className={`p-2 rounded-lg ${theme === 'light' ? 'bg-primary-100' : 'hover:bg-neutral-100'}`}
      ...
      <button
        ...
        className={`p-2 rounded-lg ${theme === 'dark' ? 'bg-primary-100' : 'hover:bg-neutral-100'}`}
      ...
      <button
        ...
        className={`p-2 rounded-lg ${theme === 'system' ? 'bg-primary-100' : 'hover:bg-neutral-100'}`}
...
## 8. Custom Theme Support (Admin)

```typescript
// Admin-configurable theme
...
async function applyCustomTheme(themeId: string): Promise<void> {
